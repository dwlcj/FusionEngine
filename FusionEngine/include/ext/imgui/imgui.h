...
namespace ImGui
{
    ...
    // Styles
	IMGUI_API void          StyleColorsVolumetric(ImGuiStyle* dst = NULL);    // new, recommended style (default)
	...
	IMGUI_API bool          ImageTextButton(ImTextureID user_texture_id,
    ...
    IMGUI_API void          PlotHistogram(const char* label, const float* values, int values_count, ImVec2 graph_size = ImVec2(0, 0), int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, int stride = sizeof(float));
