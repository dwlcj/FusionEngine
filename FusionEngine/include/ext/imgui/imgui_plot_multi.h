...
namespace ImGui {
	...
	//			if (plot_type == ImGuiPlotType_Lines)
	//			{
	//				window->DrawList->AddLine(pos0, pos1, col_base/*, v_hovered == v1_idx ? col_hovered : col_base*/);
	//			}
	//			else if (plot_type == ImGuiPlotType_Histogram)
	//			{
	//				if (pos1.x >= pos0.x + 2.0f)
	//					pos1.x -= 1.0f;
	//				window->DrawList->AddRectFilled(pos0, pos1, col_base/*v_hovered == v1_idx ? col_hovered : col_base*/);
	//			}
